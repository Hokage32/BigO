...
// ANSWER: No, any other loop would result the same.
...
// ANSWER: They both store the same amount in the object "letters" there can only be 26 letters. So it was decided that they are both O(n)
